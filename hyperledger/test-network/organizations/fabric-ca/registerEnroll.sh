...
function createOrg() {
  ...
  cp "${PWD}/organizations/fabric-ca/org${ORG}/ca-cert.pem" "${PWD}/organizations/peerOrganizations/org${ORG}.example.com/tlsca/tlsca.org${ORG}.example.com-cert.pem"
  ...
  cp "${PWD}/organizations/fabric-ca/org${ORG}/ca-cert.pem" "${PWD}/organizations/peerOrganizations/org${ORG}.example.com/ca/ca.org${ORG}.example.com-cert.pem"
  ...
  set -x
  fabric-ca-client enroll -u https://${CA_PEER_USERNAME}:${CA_PEER_PASSWORD}@localhost:${CA_SERVER_PORT} --caname ca-org${ORG} -M "${PWD}/organizations/peerOrganizations/org${ORG}.example.com/peers/peer0.org${ORG}.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org${ORG}/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://${CA_PEER_USERNAME}:${CA_PEER_PASSWORD}@localhost:${CA_SERVER_PORT} --caname ca-org${ORG} -M "${PWD}/organizations/peerOrganizations/org${ORG}.example.com/peers/peer0.org${ORG}.example.com/tls" --enrollment.profile tls --csr.hosts peer0.org${ORG}.example.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/org${ORG}/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://${CA_USER_USERNAME}:${CA_USER_PASSWORD}@localhost:${CA_SERVER_PORT} --caname ca-org${ORG} -M "${PWD}/organizations/peerOrganizations/org${ORG}.example.com/users/User1@org${ORG}.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org${ORG}/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://${CA_ADMIN_USERNAME}:${CA_ADMIN_PASSWORD}@localhost:${CA_SERVER_PORT} --caname ca-org${ORG} -M "${PWD}/organizations/peerOrganizations/org${ORG}.example.com/users/Admin@org${ORG}.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org${ORG}/ca-cert.pem"
  { set +x; } 2>/dev/null
