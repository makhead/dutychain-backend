...
infoln "Joining org${NEWORG} peer to the channel..."
joinChannel ${NEWORG}

infoln "Setting anchor peer for org${NEWORG}..."
setAnchorPeer ${NEWORG}

successln "Channel '$CHANNEL_NAME' joined"
successln "Org${NEWORG} peer successfully added to network"
